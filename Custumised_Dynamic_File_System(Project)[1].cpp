...
void man(char *name)
{
    ...
    {
        printf("Description : Used to write data to regular file\n");
...
void DisplayHelp()
{
    ...
    printf("fstat : To Display information using file descriptor(fd)");
...
int GetFDFromName(char *name)
{
    ...
    int rm_File(char *name)
    {
        ...
        if(UFDTArr[fd].ptrfiletable->ptrinode->FileType == 0)
        {
    ...
    int ReadFile(int fd, char *arr, int iSize)
    {
        ...
        else
        {
            ...
            (UFDTArr[fd].ptrfiletable->readoffset)= (UFDRArr[fd].ptrfiletable->readoffset)+iSize;
        }
        return iSize;
    }
    ...
    int main()
    {
        ...
        while(1)
        {
            ...
            else if(strcmp(command[0],"write") == 0)
            {
                ...
                if(ret == -2)
                    printf("ERROR : There is no sufficient memory ti write\n");
                if(ret == -3)
